...
Ce dépôt est le canal de livraison de le site de l'agence OptimizIA.xyz servi sur `www.optimizia.xyz`. Il contient ce qui part en
production, pas le projet : le site se développe dans le vault Obsidian et se
publie par `(C) publier.ps1` du dossier `01 site OptimizIA.xyz` du vault. Ce guide fixe ce qui se passe entre un commit
et la mise en ligne.
