/* case-study-seoplus, es. Cle = texte anglais exact du HTML, espaces normalises.
...
window.OIA_I18N.es = {
    html: {
        ...
        "Claude for the AI verdict": "Claude para el veredicto de la IA",
        "160 deterministic checks": "160 comprobaciones deterministas",
        "Supabase, data in Paris": "Supabase, datos en París",
        "24 h cache & rate limiting": "Caché de 24 h y límite de peticiones",
        "Opt-in public leaderboard": "Clasificación pública voluntaria",
        "Framework-free HTML/CSS/JS front end": "Front-end HTML/CSS/JS sin framework",
